            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  {!!Form::model($rol, ['route'=> ['rol.update', $rol ], 'method'=>'PUT', 'class'=>'col-sm-12 col-xs-12','files' => true])!!}
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                <fieldset>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Descripción (*)</label>
                                        {!! Form::text('txt_descripcion',$rol->rol_descripcion,['class' => 'form-control','id'=>'txt_descripcion', 'maxlength'=>'250','placeholder'=>'Ingrese Descripción']) !!}
                                    </div>
                                    <div class="form-group">
