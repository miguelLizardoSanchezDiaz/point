            ...
            <div class="card card-info">
              ...
              <div class="card-body">
                <div class="row">
                    ...
                    {!!Form::model($marca, ['route'=> ['marcas.update', $marca ], 'method'=>'PUT', 'class'=>'col-sm-12 col-xs-12','files' => true])!!}
                        ...
                        <div class="row">
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('txt_codigo',$marca->mar_codigo,['class' => 'form-control','id'=>'txt_codigo', 'disabled'=>'disabled', 'maxlength'=>'250','placeholder'=>'Ingrese código']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('txt_descripcion',$marca->mar_descripcion,['class' => 'form-control','id'=>'txt_descripcion', 'maxlength'=>'250','placeholder'=>'Ingrese descripción']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
