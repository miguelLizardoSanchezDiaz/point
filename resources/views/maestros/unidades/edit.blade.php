              ...
              <div class="card-body">
                <div class="row">
                    ...
                    <form id="frm_nuevo" name="frm_nuevo" class="col-sm-12 col-xs-12" accept-charset="UTF-8" enctype="multipart/form-data">
                        ...
                        <fieldset>
                        <input type="hidden" id="txt_id_registro" name="txt_id_registro" autocomplete="off" value="{{$unidad->id}}">
                        <div class="row">
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Código (*)</label>
                                    {!! Form::text('txt_codigo',$unidad->unm_codigo,['class' => 'form-control','id'=>'txt_codigo', 'disabled'=>'disabled', 'maxlength'=>'250','placeholder'=>'Ingrese código']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('txt_descripcion',$unidad->unm_descripcion,['class' => 'form-control','id'=>'txt_descripcion', 'maxlength'=>'250','placeholder'=>'Ingrese descripción']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
...
@section('script_pie')
    {!! Html::script('/js/maestros/unidades.js') !!}
@endsection