                                ...
                                <fieldset>
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('codigo',null,['class' => 'form-control','id'=>'codigo', 'maxlength'=>'250','placeholder'=>'Ingrese codigo']) !!}
                                    </div>
                                    <div id="empresa">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Razon Social (*)</label>
                                            {!! Form::text('txt_descripcion',null,['class' => 'form-control','id'=>'txt_descripcion', 'maxlength'=>'250','placeholder'=>'Ingrese razón social']) !!}
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div id="persona">
                                        ...
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('txt_nombreComercial',null,['class' => 'form-control','id'=>'txt_nombreComercial', 'maxlength'=>'250','placeholder'=>'Ingrese apellido paterno']) !!}
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Apellido Materno (*)</label>
                                            {!! Form::text('txt_nombreComercial',null,['class' => 'form-control','id'=>'txt_nombreComercial', 'maxlength'=>'250','placeholder'=>'Ingrese apellido materno']) !!}
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Fecha Nacimiento (*)</label>
                                            {!! Form::text('txt_nacimiento',null,['class' => 'form-control','id'=>'txt_nacimiento', 'maxlength'=>'250','placeholder'=>'Ingrese fecha nacimiento']) !!}
                                        </div>
                                    </div>
